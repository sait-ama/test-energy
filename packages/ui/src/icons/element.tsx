...
export const ElementIcon = createSvgIcon(
  'Element',
  <>
    <path
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M11.25 11.625H15.75" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M11.25 14.625H15.75" strokeWidth="1.5" strokeLinecap="round" />
  </>,
  { stroke: 'currentColor', fill: 'none', viewBox: '0 0 20 20' }
);
