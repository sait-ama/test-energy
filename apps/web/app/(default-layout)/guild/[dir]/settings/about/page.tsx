...
import { ChangeClubForm } from '~widgets/(settings-form)/about/ui/change-guild-form';
...
export const generateMetadata = fallbackDefaultMetadata<{ dir: string }>(
  withMetadataCache(async (props) => {
    ...
    const t = await getTranslations('pages.guild.settings.about');
