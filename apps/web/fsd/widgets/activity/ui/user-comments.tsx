...
interface CommentsProps {
  ...
  target: UserCommentsTarget;
}

export const UserComments = ({ query, target }: CommentsProps) => {
                      ...
                      <ReportModal type="comment" target={data.id}>
                        {(onOpen) => (
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent className="cs-modal-comments p-1">
  ...
  return (
    <ActivityList value={{ queryFn: ActivityRepository.user, target, queryProp: query }}>
