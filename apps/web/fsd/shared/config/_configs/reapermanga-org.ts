...
import { englishLocalization, reSocial } from '~shared/config/_configs/common';
import {
  ContentTypes,
  SiteArticles,
  SiteConfig,
...
export const reaperMangaOrgConfig = {
  contentType: ContentTypes.MANGA,
  routing: {
    hostname: SiteUrls.ReaperMangaOrg,
    url: `https://${SiteUrls.ReaperMangaOrg}`,
  },
  site: {
    contacts: {
