...
import type { Period, TimePickerType } from './utils';
...
const TimePickerInput = ({
  ...
  return (
    <Input
      ...
      name={name || picker}
      className={cn(
        'focus:bg-accent focus:text-accent-foreground w-[60px] text-center font-mono text-base tabular-nums caret-transparent [&::-webkit-inner-spin-button]:appearance-none',
        className
      )}
