...
const HorizontalStep = (props: StepSharedProps & React.ComponentProps<'div'>) => {
  const {
    isError,
    isLoading,
    onClickStep,
  ...
  return (
    <div
      ...
      className={cn(
        'stepper__horizontal-step after:min-w-[5px]',
        'relative flex items-center transition-all duration-200',
        '[&:not(:last-child)]:flex-[0.3]',
        ...
        (variant === 'circle' || variant === 'custom') &&
          `[&:not(:last-child)]:after:flex-1 ${variant !== 'custom' && '[&:not(:last-child)]:after:ms-[var(--step-gap)] [&:not(:last-child)]:after:me-[var(--step-gap)]'} `,
