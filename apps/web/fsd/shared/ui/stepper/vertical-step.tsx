...
import { Collapsible, CollapsibleContent } from '@re/ui-kit/ui/collapsible';
import { cn } from '@re/ui-kit/utils/cn';
import { cva } from 'class-variance-authority';

import { StepIcon } from '~shared/ui/stepper/step-icon';
import { StepLabel } from '~shared/ui/stepper/step-label';

import { StepButtonContainer } from './step-button-container';
import type { StepSharedProps } from './types';
import { useStepper } from './use-stepper';

type VerticalStepProps = StepSharedProps & React.ComponentProps<'div'>;
...
const VerticalStep = (props: VerticalStepProps) => {
  const {
    children,
    index,
    isCompletedStep,
    ...
    <div
      ...
      className={cn(
        ...
        verticalStepVariants({
          variant: variant === 'custom' || variant?.includes('circle') ? 'circle' : 'line',
        }),
