...
import { useController } from '~shared/lib/lightbox/modules/controller/store';
...
import { LightBoxComponentProps, SlideshowRef } from '~shared/lib/lightbox/types';
import { cleanup, makeUseContext } from '~shared/lib/lightbox/utils';
