...
import { ContainerRect } from '~shared/lib/lightbox/types';
import { isImageSlide, round } from '~shared/lib/lightbox/utils';
...
export function useZoomState(
  ...
  useIsomorphicEffect(handleControllerRectChange, [
    containerRect.width,
