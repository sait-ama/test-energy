...
import { getSlideIfPresent, getSlideIndex, makeUseContext } from '../utils';
...
export const useLightboxState = makeUseContext(
  'useLightboxState',
...
export const LightboxDispatchContext = React.createContext<LightboxDispatchContextType | null>(
  null
);
...
export type LightboxStateProviderProps = React.PropsWithChildren<
  Pick<LightboxProps, 'slides' | 'index'>
>;
