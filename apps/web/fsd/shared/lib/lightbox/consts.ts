...
export const activeSlideStatus = (status: SlideStatus): `active-slide-${SlideStatus}` =>
  `active-slide-${status}`;

export const ACTIVE_SLIDE_LOADING = activeSlideStatus(
  SLIDE_STATUS_LOADING
) as 'active-slide-loading';
export const ACTIVE_SLIDE_PLAYING = activeSlideStatus(
  SLIDE_STATUS_PLAYING
) as 'active-slide-playing';
export const ACTIVE_SLIDE_ERROR = activeSlideStatus(SLIDE_STATUS_ERROR) as 'active-slide-error';
export const ACTIVE_SLIDE_COMPLETE = activeSlideStatus(
  SLIDE_STATUS_COMPLETE
) as 'active-slide-complete';

// export const CLASS_FULLSIZE = 'fullsize';
// export const CLASS_FLEX_CENTER = 'flexCenter';
...
// v2 attrs
export const CONTAINER_DATA_ATTR = 'data-yarl-controller';
export const FLEX_CENTER_DATA_ATTR = 'data-yarl-flex-center';
export const PORTAL_OPEN_DATA_ATTR = 'data-yarl-portal-open';
export const NO_SCROLL_DATA_ATTR = 'data-yarl-no-scroll';
export const PORTAL_DATA_ATTR = 'data-yarl-portal';
export const CAROUSEL_DATA_ATTR = 'data-yarl-carousel';
export const SLIDE_DATA_ATTR = 'data-yarl-slide';
export const TOOLBAR_DATA_ATTR = 'data-yarl-toolbar';
export const BUTTON_DATA_ATTR = 'data-yarl-button';
export const NAVIGATION_PREV_DATA_ATTR = 'data-yarl-navigation-prev';
export const NAVIGATION_NEXT_DATA_ATTR = 'data-yarl-navigation-next';
export const ICON_DATA_ATTR = 'data-yarl-icon';
export const NAVIGATION_BUTTON_DATA_ATTR = 'data-yarl-button';
export const NO_SCROLL_PADDING_DATA_ATTR = 'data-yarl-no-scroll-padding';
export const FULLSIZE_DATA_ATTR = 'data-yarl-fullsize';
export const RELATIVE_DATA_ATTR = 'data-yarl-relative';
export const SLIDE_WRAPPER_DATA_ATTR = 'data-yarl-slide-wrapper';
export const INTERACTIVE_DATA_ATTR = 'data-interactive';
export const WITH_SLIDES_DATA_ATTR = 'data-with-slides';
export const COVER_DATA_ATTR = 'data-cover';
export const LOADING_DATA_ATTR = 'data-loading';
//
