...
/** Lightbox component */
export type Component = React.ComponentType<LightBoxComponentProps>;

/** Lightbox component properties */
export type LightBoxComponentProps = React.PropsWithChildren<
...
export type Augmentation = (props: LightBoxComponentProps) => LightBoxComponentProps;
...
export interface ControllerSettings {
  ...
  /** if `true`, prevent default for horizontal wheel scroll stores (for internal use only) */
  preventDefaultWheelX: boolean;
  /** if `true`, prevent default for vertical wheel scroll stores (for internal use only) */
...
export interface ControllerRef {
  ...
  focus: Callback;
  /** get lightbox props */
  getLightboxProps: () => LightBoxComponentProps;
  /** get lightbox state */
