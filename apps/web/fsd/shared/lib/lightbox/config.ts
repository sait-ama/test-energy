import { MODULE_CONTROLLER } from './consts';
import { Augmentation, Component, Module, Node, Plugin } from './types';
...
function traverseNode(
  node: Node,
  target: string,
  apply: (node: Node) => Node[] | undefined
): Node[] | undefined {
