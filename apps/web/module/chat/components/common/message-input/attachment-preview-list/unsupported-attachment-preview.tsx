...
import { FileIcon } from '../../react-file-utilities';
import { CloseIcon, DownloadIcon, LoadingIndicatorIcon, RetryIcon } from '../icons';
import type { AnyLocalAttachment } from '../types';
import type { AttachmentPreviewProps } from './types';

export type UnsupportedAttachmentPreviewProps = AttachmentPreviewProps<AnyLocalAttachment>;
...
export const UnsupportedAttachmentPreview = ({
  ...
  const title = attachment.title ?? 'Unsupported attachment';
  return (
    <div
