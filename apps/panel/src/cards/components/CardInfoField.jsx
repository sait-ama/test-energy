...
const CardInfoField = forwardRef(
    (
        { source, secondaryField = 'description', renderSecondaryField, onClick, clickable = !!onClick, ...rest },
        ref,
    ) => {
...
CardInfoField.displayName = 'CardInfoField';
